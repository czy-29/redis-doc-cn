...
请注意，在没有任何安全性的情况下暴露在互联网上的 Redis [很容易被利用](http://antirez.com/news/96)，因此请确保您了解上述内容并 **至少** 应用防火墙层。防火墙就位后，尝试从外部主机使用 `redis-cli` 连接，以证明您自己的实例在事实上无法访问。
